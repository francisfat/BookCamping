...
<html>
	...
	<body>
			...
			<%
				...
				<% }else if(alert == "2"){ %>
					    <div class="alert alert-danger" role="alert" >
						  Errore! CVV e Card Number sono costituiti da sole cifre!
						  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
				<% }else if(alert == "3"){ %>
					    <div class="alert alert-danger" role="alert" >
						  Errore! CVV e Card Number non hanno un formato corretto!
						  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
				<% }else if(alert == "4"){ %>
					    <div class="alert alert-danger" role="alert" >
			...
			%>
					...
					<input type="hidden" name="arr" value=${ pren.getArrivo()} />
					<input type="hidden" name="part" value=${ pren.getPartenza()} />
