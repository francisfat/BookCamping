			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<div class="row justify-content-md-center">
							<div class="col-md-auto ">
								<br><br><a href="prenotacaval.jsp">Prenota ora</a>
							</div>
						</div>
					</div>	
				</div>
				...
				<div class="row">
					<div class="col-sm-8">
						<h4> Trekking guidato </h4>
						L'escursioni di trekking si tengono ogni giorno: partono alle 9:00 di mattina e terminano alle 12:30. 
						...
						da un professionista che ti consentirà di camminare per chilometri nella natura incontaminata delle montagne dell'Abruzzo 
						 ...
						 <br>Partenza: <i>  via Borgo Nuovo, Villetta Barrea </i>
						 <br>Durata: <b> 3 ore e 30 minuti</b>
						 <br>Prezzo: <b> 10 euro a persona</b>
						<div class="row justify-content-md-center">
							<div class="col-md-auto ">
								<br><a href="prenotatrek.jsp">Prenota ora</a>
							</div>
						</div>
					</div>	
					<div class="col-sm-4">
