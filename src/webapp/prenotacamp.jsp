	...
	<body>
		...
		<%
			String alert = (String) session.getAttribute("alert");	
				...
				<% }else if(alert == "2"){ %>
					    <div class="alert alert-danger" role="alert" >
						  Errore! La partenza deve essere successiva all'arrivo!
						  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
				<% }else if(alert == "3"){ %>
					    <div class="alert alert-danger" role="alert" >
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<input type="hidden" class="form-control"  name="username" value=${ user} />
					*Arrivo:  <br><input name="giornoarrivo" type="date"><br><br>
					*Partenza:<br><input name="giornopartenza" type="date"><br><br>	
					...
					*Tipologia piazzola : <select name="piazzola">
					...
					<img height="110" width="420" alt="..." src="immagini/costioptional.png"><br><br>
