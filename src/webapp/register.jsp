		...
		<%			
			...
			<div class="row">
				<div class="col-sm-8">
					...
					*Cellulare:<input type="text" class="form-control" placeholder="Cellulare" aria-label="Cellulare" aria-describedby="basic-addon1" name="cellulare"><br><br>
					*e-mail:<input type="text" class="form-control" placeholder="e-mail" aria-label="e-mail" aria-describedby="basic-addon1" name="e-mail"><br><br>
