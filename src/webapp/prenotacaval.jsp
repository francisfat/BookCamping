			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<h4> Escursioni a cavallo </h4><br>
					 L'escursioni a cavallo si tengono ogni giorno: partono alle <b> ${list.get(0).getOraInizio() }</b> 
					 di pomeriggio e terminano alle <b> ${list.get(0).getOraFine() }</b>. 
					 L'escursione ti consentirà di visitare tutto ciò che c'è di bello nella natura incontaminata delle montagne dell'Abruzzo.
